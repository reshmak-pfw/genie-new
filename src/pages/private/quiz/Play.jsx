...
// Disable Next Button
   ...
   render() {
    ...
    return (
      <>
        <Head>
          <title>Genie | Quiz 1</title>
        </Head>
        <section className="bg-gradient-to-r from-pink-700 to-purple-700 p-5 mt-10">
          {/** Lifeline, Hints and Timer */}
          <div className="flex justify-between items-center pb-4">
            <div className="inline-flex items-center cursor-grabbing hover:bg-pink-500 hover:rounded-lg">
              <span onClick={this.handleTossUpClick}>
                <GiLifeInTheBalance className="text-pink-900 h-7 w-7" />
              </span>
              <div className="px-1">{tossUp}</div>
            </div>
            <div className="inline-flex items-center cursor-grabbing hover:bg-purple-500 hover:rounded-lg">
          ...
          <div className="flex justify-center space-x-2 mb-7">
            <button
              ...
              className="inline-flex items-center rounded bg-amber-700 px-6 pt-2.5 pb-2 text-xs disabled:opacity-30 font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#54b4d3] transition duration-150 ease-in-out hover:bg-info-600 hover:shadow-[0_8px_9px_-4px_rgba(84,180,211,0.3),0_4px_18px_0_rgba(84,180,211,0.2)] focus:bg-info-600 focus:shadow-[0_8px_9px_-4px_rgba(84,180,211,0.3),0_4px_18px_0_rgba(84,180,211,0.2)] focus:outline-none focus:ring-0 active:bg-info-700 active:shadow-[0_8px_9px_-4px_rgba(84,180,211,0.3),0_4px_18px_0_rgba(84,180,211,0.2)]"
            >
              <FcPrevious />
